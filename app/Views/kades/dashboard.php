        ...
        <div class="card">
            ...
            <tbody>
                ...
                <?php if (user()->toArray()['is_superadmin'] == '2') : ?>
                   <a href="" type="button" class="btn btn-diabled p-2" id="<?= $value['kode_surat']; ?>">
                    <i class="material-icons">edit</i></a>
                    <button onclick="return confirm('Maaf Pak Kades biarkan Administrator yang menghapus');" type="submit" class="btn btn-disabled p-2" id="<?= $value['id_surat']; ?>">
