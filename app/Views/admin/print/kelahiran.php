...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Nama</td><td>:</td><td><?php echo $dt[13];?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Tmp. & Tgl. Lahir </td><td>:</td><td><?php echo ucwords(strtolower($dt[15]));?>, <?php echo $dt[16];?></td>
  </tr>
  <tr>
    <td>Anak ke</td><td>:</td><td><?php echo $dt[19];?> (<?php echo kekata($dt[19]);?> )</td>
  </tr>
    <tr>
