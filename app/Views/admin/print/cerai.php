...
<table align="center" class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td><b>I.</b></td><td colspan="3"><b>MANTAN SUAMI :</b></td>
  </tr>
  <tr>
  ...
  <tr>
    <td></td><td>Tmp. & Tgl. Lahir </td><td>:</td><td><?php echo ucwords(strtolower($dt[2]));?>, <?php echo$dt[3];?></td>
  </tr>
    <tr>
  ...
  <tr>
    <td><b>II.</b></td><td colspan="3"><b>MANTAN ISTRI :</b></td>
  </tr>
  ...
  <tr>
    <td></td><td>Tmp. & Tgl. Lahir </td><td>:</td><td><?php echo ucwords(strtolower($dt[8]));?>, <?php echo $dt[9];?></td>
  </tr>
    <tr>
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td colspan="3">Warga tersebut diatas adalah bernar Warga <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?> yang telah Bercerai sejak <?php echo IndonesiaTgl($dt[12]);?>.</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
