...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="3" align="justify">Yang bertanda tangan dibawah ini <?php echo $ds['jnp']=='Desa'? "Kepala Desa" : "Lurah";?> <?php echo $ds['desa'];?> Kecamatan <?php echo $ds['kec'];?> Kabupaten <?php echo $ds['kab'];?>, menerangkan bahwa : </td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td width="20%">Nama</td><td>:</td><td><?php echo $dt[1];?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="3" align="justify">Nama tersebut diatas adalah Warga <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?> yang telah Berdomisili / tinggal menetap secara berturut - turut sejak <?php echo $dt[7]; ?> sampai dengan sekarang.</td>
  </tr>
  <tr>
    <td colspan="3">Adapun Surat Keterangan ini dibuat untuk melengkapi persyaratan <b><?php echo $dt[8];?></b>.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
