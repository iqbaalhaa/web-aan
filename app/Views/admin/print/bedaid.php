...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="3" align="justify">Yang bertanda tangan dibawah ini <?php echo $ds['jnp']=='Desa'? "Kepala Desa" : "Lurah";?> <?php echo $ds['desa'];?> Kecamatan <?php echo $ds['kec'];?> Kabupaten <?php echo $ds['kab'];?>, menerangkan bahwa Identitas Warga Kelurahan <?php echo $ds['desa'];?>  dibawah ini terdapat perbedaan antara <?php echo $dt[7];?>  dengan <?php echo $dt[15];?>  sebagai berikut :</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td>Tmp.&Tgl. Lahir</td><td>:</td><td><?php echo ucwords(strtolower($dt[3]));?>, &nbsp;<?php echo $dt[4];?></td>
  </tr>
    <tr>
    <td>Agama</td><td>:</td><td><?php echo $dt[5];?></td>
  </tr>
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[6];?> 
<tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <tr>
    <td>Tmp.&Tgl. Lahir</td><td>:</td><td><?php echo ucwords(strtolower($dt[11]));?>, &nbsp; <?php echo $dt[12];?></td>
  </tr>
    <tr>
    <td>Agama</td><td>:</td><td><?php echo $dt[13];?></td>
  </tr>
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[14];?>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    ...
    <tr>
    <td colspan="3">Warga dengan Identitas tersebut diatas adalah benar <b>Orang yang sama</b> yang merupakan Warga <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?>.</td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
