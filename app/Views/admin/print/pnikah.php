...
<tr>
    <td colspan="4">Warga tersebut diatas adalah bernar Warga <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?> dan yang bersangkutan Pernah Menikah secara <?php echo $dt[17];?> pada <?php echo IndonesiaTgl($dt[16]);?> dengan :
</td>
  </tr>
  <tr><td colspan="3"></td></tr>
    <tr>
    <td>1. </td><td>Nama </td><td>:</td><td><?php echo $dt[9];?></td>
  </tr>
  <tr>
    <td>2. </td><td>NIK</td><td>:</td><td><?php echo $dt[8];?></td>
  </tr>
    <tr>
    <td>3. </td><td>Tmp.&Tgl. Lahir</td><td>:</td><td><?php echo ucwords(strtolower($dt[10]));?>, &nbsp; <?php echo $dt[11];?></td>
  </tr>
  <tr>
    <td>4. </td><td>Kewarganegaraan</td><td>:</td><td><?php echo $dt[12];?></td>
  </tr>
    <tr>
    <td>5. </td><td>Agama</td><td>:</td><td><?php echo $dt[13];?></td>
  </tr>
  <tr>
    <td>6. </td><td>Pekerjaan</td><td>:</td><td><?php echo $dt[14];?></td>
  </tr>
  <tr>
    <td>7. </td><td valign="top">Alamat</td><td valign="top">:</td><td valign="top"><?php echo $dt[15];?></td>
  </tr>
  <tr>
    <td colspan="4">&nbsp;</td>
  </tr>
