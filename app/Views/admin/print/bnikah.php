...
?>
  ...
  <table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
      ...
      <td>Tmp.&Tgl. Lahir</td>
      <td>:</td>
      <td><?php echo ucwords(strtolower($dt[2])); ?>, &nbsp;<?php echo $dt[3]; ?></td>
    </tr>
    <tr>
      <td>4. </td>
    ...
    <tr>
      ...
      <td valign="top">:</td>
      <td valign="top"><?php echo $dt[7]; ?></td>
    </tr>
    <tr>
      <td colspan="3"></td>
    </tr>
    <tr>
      <td colspan="4">Warga tersebut diatas adalah bernar Warga <?php echo $ds['jnp'] == 'Desa' ? "Desa" : "Kelurahan"; ?> <?php echo $ds['desa']; ?> dan yang bersangkutan Belum Pernah Menikah dengan siapapun dan Masih berstatus Perjaka / Gadis *)
    </tr>
    <tr>
      <td colspan="4">&nbsp;</td>
    </tr>
