...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">Adalah benar Warga <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?> Kecamatan <?php echo $ds['kec'];?> dan benar berkelakuan baik serta tidak pernah terlibat dalam kasus Pidana maupun Perdata serta tidak pernah terlibat kasus kenakalan Remaja ataupun pemakaian obat-obatan terlarang (Narkoba). <br><br>Surat Keterangan ini diberikan kepada yang bersangkutan untuk <?php echo $dt[7];?>.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
