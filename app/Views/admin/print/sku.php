...
?>
  ...
  <table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
    ...
    <tr>
      <td>Alamat</td>
      <td>:</td>
      <td><?php echo $dt['4']; ?> <?php echo $ds['jnp'] == 'Desa' ? "Desa" : "Kelurahan"; ?> <?php echo $ds['desa']; ?></td>
    </tr>
    ...
    <tr>
      <td colspan="3">Nama tersebut adalah benar Warga <?php echo $ds['jnp']; ?> <?php echo $ds['desa']; ?> yang memiliki Usaha sebagai berikut :</td>
    </tr>
    <tr>
    ...
    <tr>
      <td>Berjalan Sejak</td>
      <td>:</td>
      <td><?php echo IndonesiaTgl($dt[6]); ?></td>
    </tr>
    <tr>
