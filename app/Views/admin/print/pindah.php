...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Nama Lengkap</td><td>:</td><td><?php echo $dt[2];?></td>
  </tr>
      <tr>
    <td>No. Induk Kependudukan</td><td>:</td><td><?php echo $dt[0];?></td>
  </tr>
  <tr>
    <td>No. Kartu Keluarga</td><td>:</td><td><?php echo $dt[1];?></td>
  </tr>
  <tr>
    <td>Jenis Kelamin</td><td>:</td><td><?php echo $dt[3];?></td>
  </tr>
  <tr>
    <td>Tmp.&Tgl. Lahir</td><td>:</td><td><?php echo ucwords(strtolower($dt[4]));?>, <?php echo $dt[5];?></td>
  </tr>
    <tr>
    <td>Agama</td><td>:</td><td><?php echo $dt[6];?></td>
  </tr>
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[7];?> <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?></td>
  </tr>
  <tr>
    <td></td><td></td><td>Kec. <?php echo $ds['kec'];?> Kab. <?php echo $ds['kab'];?></td>
  </tr>
    <tr>
    <td>Tujuan Pindah</td><td>:</td><td><?php echo $dt[8];?></td>
  </tr>
      <tr>
    <td>Jumlah Keluarga yang Ikut</td><td>:</td><td><?php echo $dt[9];?> Orang</td>
  </tr>
