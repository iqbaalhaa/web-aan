...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <tr>
    <td>Nama Ternak</td><td>:</td><td><b><?php echo $dt[5];?></b></td>
  </tr>
    <tr>
    <td>Jenis Ternak</td><td>:</td><td><?php echo $dt[6];?></td>
  </tr>
    <tr>
    <td>Ciri - ciri Ternak</td><td>:</td><td><?php echo $dt[7];?></td>
  </tr>
    <tr>
    <td>Asal Ternak/dari</td><td>:</td><td><?php echo $dt[8];?></td>
  </tr>
    <tr>
    <td>Tujuan Ternak/dikirim ke</td><td>:</td><td><?php echo $dt[9];?></td>
  </tr>
  ...
  <tr>
    <td>Nama</td><td>:</td><td><b><?php echo $dt[1];?></b></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="3">yang akan dikirim dengan Kendaraan/Mobil, No. Polisi / Plat : <?php echo $dt[10];?></td>
  </tr>
