...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <table align="center" class="table" width="90%" border="1" cellspacing="1" cellpadding="6">
    <tr>
    ...
    <?php $no=1; foreach ($waris as $raw ) :
  
?>
    <tr>
      <td align="center"><?php echo $no++;?></td>
      <td><?php echo $raw['nm'];?></td>
      <td align="center"><?php echo $raw['jk'];?></td>
      <td align="left"><?php echo $raw['ttl'];?></td>
      <td align="left"><?php echo $raw['alamat'];?></td>
      <td align="left"><?php echo $raw['agama'];?></td>
