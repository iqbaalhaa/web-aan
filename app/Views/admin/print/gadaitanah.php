...
<table align="center" class="table-list" width="90%" border="0" cellspacing="0" cellpadding="1">
  ...
  <tr>
    <td valign="top">1.</td><td colspan="4" align="justify">Tanah dengan luas/ukuran <?php echo format_angka($dt[12]);?> M2 <i>(<?php echo kekata($dt[12]);?> Rupiah)</i> yang terletak di <?php echo $dt[13];?>, dengan batas - batas tanah : </td>
  </tr>
  <tr>
 ...
 <tr>
    <td></td><td align="center"><br>Pihak II<br>Menerima Gadai </td><td><td></td><td align="center"><?php echo $ds['desa'];?>,&nbsp;<?php echo $bulan;?><br>Pihak I<br>Yang Menggadaikan</td>
  </tr>
     <tr>
...
<table width="90%" align="right" border="0" cellspacing="1" cellpadding="2" class="table-print">
  ...
  <tr>
    <td rowspan="3" width="20%"></td><td align="center" valign="top" class="pull pull-right"><?php echo $ds['jnp']=='Desa'? "Kepala Desa" : "Lurah";?> <?php echo $ds['desa'];?><br><small><?php echo $sr['no_surat'];?></small></td>
  </tr>
  <tr>
    <td align="center" class="pull pull-right"></td>
  </tr>
  <tr>
    <td align="center" class="pull pull-right" width="45%" colspan="2"><br><br><br><u><b><?php echo $sr['nama'];?></b></u><br>NIP. <?php echo $sr['nip'];?></td>
  </tr> 
</table>
</td>
</tr>
