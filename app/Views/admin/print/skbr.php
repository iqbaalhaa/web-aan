...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <tr>
    <td>Nama Barang</td><td>:</td><td><b><?php echo $dt[5];?></b></td>
  </tr>
    <tr>
    <td>Jenis/Model Barang</td><td>:</td><td><?php echo $dt[6];?></td>
  </tr>
    <tr>
    <td>Jumlah/Ukuran/Berat</td><td>:</td><td><?php echo $dt[7];?></td>
  </tr>
    <tr>
    <td>Asal Barang/dari</td><td>:</td><td><?php echo $dt[8];?></td>
  </tr>
    <tr>
    <td>Tujuan Barang/dikirim ke</td><td>:</td><td><?php echo $dt[9];?> </td>
  </tr>
