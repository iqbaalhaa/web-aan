...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <td colspan="3">&nbsp;</td>
      ...
      <tr>
    <td colspan="3">Warga tersebut diatas adalah benar Warga <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?>
 <?php echo $ds['desa'];?> dengan Penghasilan sebagai berikut :</td>
  </tr>
      <tr>
    <td>Jumlah Penghasilan</td><td>:</td><td><b><?php echo $dt[7];?></b></td>
  </tr>
      <tr>
    <td>Sumber Penghasilan</td><td>:</td><td><?php echo $dt[8];?></td>
  </tr>
