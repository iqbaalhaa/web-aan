...
<tr>
  ...
  <tr>
    ...
    <tr>
    <td colspan="4">Warga tersebut diatas adalah benar warga <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?> yang masuk dalam kategori Keluarga Tidak Mampu sesuai Data Terpadu Kesejahteraan Sosial (DTKS).</td>
  </tr>
  <tr>
