...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    <td>Nama Lembaga</td><td>:</td><td><b><?php echo $dt[3];?></b></td>
  </tr>
  <tr>
    <td>Bidang</td><td>:</td><td><?php echo $dt[4];?></td>
  </tr>

    <tr>
    <td>Berdiri Sejak</td><td>:</td><td><?php echo IndonesiaTgl($dt[5]);?></td>
  </tr>
    <tr>
    <td>Alamat/Lokasi</td><td>:</td><td><?php echo $dt[6];?></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3">PIMPINAN/KETUA :</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[2];?> <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3">Lembaga/Organisai tersebut adalah benar telah berdiri dan berada sesuai alamat tersebut diatas, sejak <?php echo IndonesiaTgl($dt[5]);?> dan masih aktif sampai dengan sekarang.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
