...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    <td colspan="3" align="justify">Yang bertanda tangan dibawah ini <?php echo $ds['jnp']=='Desa'? "Kepala Desa" : "Lurah";?>
 <?php echo $ds['desa'];?> Kecamatan <?php echo $ds['kec'];?> Kabupaten <?php echo $ds['kab'];?>, menerangkan bahwa : </td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[6];?> <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?>
 <?php echo $ds['desa'];?></td>
  </tr>
  <tr>
    <td></td><td></td><td>Kec. <?php echo $ds['kec'];?> Kab. <?php echo $ds['kab'];?></td>
  </tr>
  <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="3" align="justify">Nama tersebut diatas adalah Warga <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?> yang telah meninggal dunia dan di <b>Kuburkan di <?php echo $dt[8]; ?> <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?>  pada tanggal <?php echo $dt[7]; ?></b>.</td>
  </tr>
    <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
