...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo $dt[5]?>  <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?>
 <?php echo $ds['desa'];?></td>
  </tr>
  ...
  <tr>
    <td></td><td width="25%">Nama</td><td>:</td><td><?php echo $dt[7];?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td></td><td>Alamat</td><td>:</td><td><?php echo $dt[11];?>  <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?>
 <?php echo $ds['desa'];?></td>
  </tr>
  </table>
...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  ...
  <tr>
    ...
    <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[18];?> <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?>
 <?php echo $ds['desa'];?></td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
