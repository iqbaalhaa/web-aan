...
<table align="center" class="table-list" width="800" border="0" cellspacing="1" cellpadding="2">
  <tr>
    ...
    <tr>
    <td>Nama Usaha</td><td>:</td><td><b><?php echo $dt[5];?></b></td>
  </tr>
    <tr>
    <td>Jenis/Bidang Usaha</td><td>:</td><td><?php echo $dt[6];?></td>
  </tr>
    <tr>
    <td>Tahun Berdiri</td><td>:</td><td><?php echo IndonesiaTgl($dt[7]);?></td>
  </tr>
    <tr>
    <td>Nama Pemilik Usaha</td><td>:</td><td><?php echo $dt[1];?></td>
  </tr>
    <tr>
    <td>Jumlah Pekerja</td><td>:</td><td><?php echo $dt[8];?> Orang</td>
  </tr>
    <tr>
    <td>Izin Usaha</td><td>:</td><td><?php echo $dt[9];?></td>
  </tr>
    <tr>
    <td>Alamat Tempat Usaha</td><td>:</td><td><?php echo $dt[10];?></td>
  </tr>
      <tr>
    <td colspan="3">&nbsp;</td>
  </tr>
    <tr>
    <td colspan="3">Tempat Usaha tersebut berlokasi di <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?> dan merupakan milik :</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <tr>
    <td>Agama</td><td>:</td><td><?php echo $dt[3];?> </td>
  </tr>
  <tr>
    <td>Alamat</td><td>:</td><td><?php echo $dt[4];?> <?php echo $ds['jnp']=='Desa'? "Desa" : "Kelurahan";?> <?php echo $ds['desa'];?></td>
  </tr>
