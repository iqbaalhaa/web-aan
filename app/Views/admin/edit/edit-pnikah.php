         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Pernah Menikah</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-pnikah'); ?>" method="post">
                     <?= csrf_field() ?>
               ...
               <h4 class="mt-4"><strong>ISTRI : </strong></h4>
                  <hr>
                     ...
                     <div class="col-md-6 mt-2">
                        ...
                        <input type="text" id="niki" name="niki" value="<?= $dt[8]; ?>" class="form-control col-md-12" required style="font-size: 18px; box-shadow: 4px 4px 6px;">
                     </div>
                     <div class="col-md-6 mt-2">
                        <label for="namai">Nama </label>
                        <input type="text" id="namai" name="namai" value="<?= $dt[9]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-4">
                        <label for="tmpli">Tempat Lahir</label>
                        <input type="text" id="tmpli" name="tmpli" value="<?= $dt[10]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="tglli">Tanggal Lahir</label>
                        <input type="text" id="tglli" name="tglli" value="<?= $dt[11]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="kwngi">Kewarganegaraan</label>
                        <input type="text" id="kwngi" name="kwngi" value="<?= $dt[12]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-2">
                        <label for="agamai">Agama</label>
                        <input type="text" id="agamai" name="agamai" value="<?= $dt[13]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="kerjaani">Pekerjaan</label>
                        <input type="text" id="kerjaani" name="kerjaani" value="<?= $dt[14]; ?>"class="form-control col-md-6" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="alamati">Alamat</label>
                        <input type="text" id="alamati" name="alamati" value="<?= $dt[15]; ?>"class="form-control col-md-12" required>
                     </div>
                  </div>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        ...
                        <input type="date" id="tgl" name="tgl" value="<?= $dt[16]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-6">
                        <label for="secara">Secara</label>
                        <input type="text" id="secara" name="secara" value="<?= $dt[17]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
