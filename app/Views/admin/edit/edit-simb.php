   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Permohonan Mendirikan Bangunan</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-simb'); ?>" method="post">
                     <?= csrf_field() ?>
         ...
         <?php foreach($surat as $data): ?>
                  ...
                  <br>
                  <h4 class="mt-2"><strong>DATA BANGUNAN </strong></h4>
                  <hr>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="jenis_bangunan">Jenis Bangunan</label>
                        <input type="text" id="jenis_bangunan" name="jenis_bangunan" value="<?= $dt['8']; ?>" class="form-control col-md-12" required>
                        <small>Contoh : Ruko, Rumah Tinggal</small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="fungsi_bangunan">Fungsi Bangunan</label>
                        <input type="text" id="fungsi_bangunan" name="fungsi_bangunan" value="<?= $dt['8']; ?>" class="form-control col-md-12" required>
                        <small>Contoh : Produksi, Gudang, atau Tempat Tinggal</small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-2">
                        <label for="jumlah_lantai">Jumlah Lantai</label>
                        <input type="number" id="jumlah_lantai" name="jumlah_lantai" value="<?= $dt['10']; ?>"class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-6">
                        <label for="ukuran_bangunan">Ukuran Bangunan</label>
                        <input type="text" id="ukuran_bangunan" name="ukuran_bangunan" value="<?= $dt['11']; ?>"class="form-control col-md-6" required>
                        <small>Contoh : 6x9 Meter</small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="lokasi_bangunan">Lokasi Bangunan</label>
                        <input type="text" id="lokasi_bangunan" name="lokasi_bangunan" value="<?= $dt['12']; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <h4 class="mt-4"><strong>LEMBAGA YANG BERWENANG </strong></h4>
                  <hr>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="ke">Ditujukan ke</label>
                        <input type="text" id="ke" name="ke" value="<?= $dt['13']; ?>" class="form-control col-md-12" required>
                        <small>Contoh : Ka. Kepala Dinas Penanaman Modal dan Pelayanan Terpadu Kabupaten Lampung Selatan</small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="di">Alamat/di</label>
                        <input type="text" id="di" name="di" value="<?= $dt['14']; ?>" class="form-control col-md-12" required>
                        <small>Contoh : KALIANDA atau TEMPAT</small>
                     </div>
                  </div>
                  <br>
