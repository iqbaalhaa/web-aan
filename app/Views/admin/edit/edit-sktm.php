         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Tidak Mampu (Personal)</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-sktm'); ?>" method="post">
                  ...
                  <div class="row mt-2">
                     ...
                     <input type="text" id="untuk" name="untuk" value="<?= $dt['7']; ?>" class="form-control col-md-6" required>
                  </div>
               </div>
