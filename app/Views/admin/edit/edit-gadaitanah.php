         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Pernyataan Gadai Tanah</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-gadaitanah'); ?>" method="post">
                     <?= csrf_field() ?>
...
<nav>
            ...
            <div class="tab-pane fade show active" id="Pihak1" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                  <h4 class="mt-4"><strong>IDENTITAS YANG MENGGADAIKAN (PIHAK I): </strong></h4>
                  <hr>
                     <div class="row mt-2">
                     <div class="col-md-6">
               ...
               <div class="tab-pane fade show" id="Pihak2" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                  <h4 class="mt-4"><strong>IDENTITAS YANG MENERIMA GADAI (PIHAK II): </strong></h4>
                  <hr>
                     <div class="row mt-2">
                     <div class="col-md-6">
               ...
               <h4 class="mt-4"><strong>DATA TANAH : </strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        <label for="nilai">Nilai Gadai </label>
                        <input type="number" id="nilai" name="nilai" value="<?= $dt[14]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
               ...
               <h4 class="mt-4"><strong>BATAS - BATAS TANAH :</strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        ...
                        <input type="text" id="barat" name="barat" value="<?= $dt[15]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="utara">Batas Utara</label>
                        <input type="text" id="utara" name="utara" value="<?= $dt[16]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="timur">Batas Timur</label>
                        <input type="text" id="timur" name="timur" value="<?= $dt[17]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="selatan">Batas Selatan</label>
                        <input type="text" id="selatan" name="selatan" value="<?= $dt[18]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
               </div>
               <div class="tab-pane fade show" id="Saksi" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                  ...
                  <div class="row mt-2">
                     <div class="col-md-6">
                        ...
                        <input type="text" id="saksi1" name="saksi1" value="<?= $dt[19]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-6">
                        <label for="saksi2">Nama Saksi 2</label>
                        <input type="text" id="saksi2" name="saksi2" value="<?= $dt[20]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
