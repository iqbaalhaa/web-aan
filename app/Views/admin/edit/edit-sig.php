         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Izin Gangguan</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-sig'); ?>" method="post">
                     <?= csrf_field() ?>
         ...
         <?php foreach($surat as $data): ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <div class="col-md-6">
                        ...
                        <input type="text" id="kerjaan" name="kerjaan" value="<?= $dt['3']; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                  ...
                  <br>
                  <h4 class="mt-2"><strong>DATA USAHA / KEGIATAN YANG DILAKUKAN </strong></h4>
                  <hr>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="nama_usaha">Nama Usaha/Kegiatan</label>
                        <input type="text" id="nama_usaha" name="nama_usaha" value="<?= $dt['5']; ?>" class="form-control col-md-12" required>
                        <small>Contoh : Produksi Tahu </small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="lokasi_usaha">Lokasi Usaha/Kegiatan</label>
                        <input type="text" id="lokasi_usaha" name="lokasi_usaha" value="<?= $dt['6']; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="tetangga">Jumlah Tetangga yang memberikan Izin</label>
                        <input type="number" id="tetangga" name="tetangga" value="<?= $dt['7']; ?>" class="form-control col-md-2" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="untuk">Peruntukan Surat</label>
                        <input type="text" id="untuk" name="untuk" value="<?= $dt['8']; ?>" class="form-control col-md-12" required>
                        <small>Salah satu persyaratan Permohon Izin Mendirikan Bangunan (IMB)</small>
                     </div>
                  </div>
                  <br>
