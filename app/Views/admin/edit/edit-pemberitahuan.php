         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Pemberitahuan</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-pemberitahuan'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <?php foreach($surat as $data): ?>
                     ...
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           ...
                           <input type="text" id="perihal" name="perihal" value="<?= $dt[0]; ?>" class="form-control col-md-12" required><small>Contoh : Jadwal Penyerahan BLT Dana Desa Bulan Oktober 2023</small>
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
