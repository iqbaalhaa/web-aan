         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Kematian Suami/Istri (N6)</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-n6'); ?>" method="post">
                     <?= csrf_field() ?>
...
<?php foreach($surat as $data): ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <div class="col-md-4">
                        ...
                        <input type="text" id="tmpl" name="tmpl" value="<?= $dt[4]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="tgll">Tanggal Lahir</label>
                        <input type="text" id="tgll" name="tgll" value="<?= $dt[5]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-2">
                        <label for="agama">Agama</label>
                        <input type="text" id="agama" name="agama" value="<?= $dt[7]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-3">
                        <label for="kwng">Kewarganegaraan</label>
                        <input type="text" id="kwng" name="kwng" value="<?= $dt[6]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-9">
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        ...
                        <input type="date" id="tanggal" name="tanggal" value="<?= $dt[18]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-6">
                        <label for="tempat">Tempat</label>
                        <input type="text" id="tempat" name="tempat" value="<?= $dt[19]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>                  
                  <br>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-6">
                        ...
                        <input type="text" id="niki" name="niki" value="<?= $dt[9]; ?>" class="form-control col-md-12" required style="font-size: 18px; box-shadow: 4px 4px 6px;">
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-6">
                        <label for="namai">Nama</label>
                        <input type="text" id="namai" name="namai" value="<?= $dt[10]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-6">
                        <label for="bini">Bin/Binti</label>
                        <input type="text" id="bini" name="bini" value="<?= $dt[11]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-3">
                        <label for="jki">Jenis Kelamin</label>
                        <input type="text" id="jki" name="jki" value="<?= $dt[12]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-4">
                        <label for="tmpli">Tempat Lahir</label>
                        <input type="text" id="tmpli" name="tmpli" value="<?= $dt[13]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="tglli">Tanggal Lahir</label>
                        <input type="text" id="tglli" name="tglli" value="<?= $dt[14]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-2">
                        <label for="agamai">Agama</label>
                        <input type="text" id="agamai" name="agamai" value="<?= $dt[16]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-3">
                        <label for="kwngi">Kewarganegaraan</label>
                        <input type="text" id="kwngi" name="kwngi" value="<?= $dt[15]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-9">
                        <label for="alamati">Alamat Terakhir</label>
                        <input type="text" id="alamati" name="alamati" value="<?= $dt[17]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <select id="shdk" name="shdk" class="form-control col-md-6" required>
                           <option value="<?= $dt[20]; ?>" selected><?= $dt[20]; ?></option>
