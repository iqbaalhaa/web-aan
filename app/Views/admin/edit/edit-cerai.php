         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Cerai</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-cerai'); ?>" method="post">
                     <?= csrf_field() ?>
...
<?php foreach($surat as $data): ?>
                  ...
                  <hr>
                  <h4 class="mt-4"><strong>DATA MANTAN SUAMI</strong></h4>
                  <hr>
                     <div class="row mt-2">
               ...
               <h4 class="mt-4"><strong>DATA MANTAN ISTRI : </strong></h4>
                  <hr>
                     <div class="row mt-2">
                     <div class="col-md-6 mt-2">
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="tglcerai">Tanggal Bercerai</label>
                        <input type="date" id="tglcerai" name="tglcerai" value="<?= $dt[12]; ?>" class="form-control col-md-3" required>
                     </div>
                  </div>
