         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Domisili Lembaga/Organisasi</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-sklbg'); ?>" method="post">
                     ...
                     <div class="row mt-2">
                        <div class="col-md-12">
                           ...
                           <input type="text" id="nama_lembaga" name="nama_lembaga" value="<?= $dt[3]; ?>" class="form-control col-md-12" required>
                        </div>
                     </div>
                     <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="bidang_lembaga">Bidang</label>
                        <input type="text" id="bidang_lembaga" name="bidang_lembaga" value="<?= $dt[4]; ?>" class="form-control col-md-6" required>
                     </div>
                  </div>
                     <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="sejak">Berdiri sejak</label>
                        <input type="date" id="sejak" name="sejak" value="<?= $dt[5]; ?>" class="form-control col-md-3" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="lokasi">Lokasi/Alamat </label>
                        <input type="text" id="lokasi" name="lokasi" value="<?= $dt[6]; ?>" class="form-control" required>
                     </div>
                  </div>
                  <br>
                  <h4>PIMPINAN/KETUA</h4>
                  <hr>
                     <div class="row mt-2">
                        <div class="col-md-6">
                           <label for="nik">NIK Pimpinan</label>
                     ...
                     <div class="row mt-2">
                        <div class="col-md-12">
                           ...
                           <input type="text" id="alamat" name="alamat" value="<?= $dt[2]; ?>" class="form-control col-md-12" required>
                        </div>
                     </div>
