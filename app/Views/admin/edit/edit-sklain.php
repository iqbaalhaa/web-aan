         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Lain-lain</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-sklain'); ?>" method="post">
                     <?= csrf_field() ?>
...
<?php foreach($surat as $data): ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="nmsurat" name="nmsurat" value="<?= $dt[8]; ?>" class="form-control col-md-6" required><small>Misalnya : Surat Keterangan Kehilangan</small>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-12">
                     <label for="isi">Isi Surat</label>
                     <textarea rows="5" id="isi" name="isi" class="form-control col-md-12" required><?= $dt[9]; ?>
