   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Pengantar Pindah</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-pindah'); ?>" method="post">
                     <?= csrf_field() ?>
         ...
         <?php foreach($surat as $data): ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="tujuan">Tujuan Pindah</label>
                        <input type="text" id="tujuan" name="tujuan" value="<?= $dt[8]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="keluarga">Jumlah Keluarga yang Ikut Pindah</label>
                        <input type="number" id="keluarga" name="keluarga" value="<?= $dt[9]; ?>" class="form-control col-md-3" required>
                     </div>
                  </div>
