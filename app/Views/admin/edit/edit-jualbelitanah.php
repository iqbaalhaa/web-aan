         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Pernyataan Jual Beli Tanah</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-jualbelitanah'); ?>" method="post">
                     <?= csrf_field() ?>
...
<nav>
            ...
            <div class="tab-pane fade show active" id="Pihak1" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                  <h4 class="mt-4"><strong>IDENTITAS YANG MENJUAL (PIHAK I): </strong></h4>
                  <hr>
                     <div class="row mt-2">
                     <div class="col-md-6">
               ...
               <div class="tab-pane fade show" id="Pihak2" role="tabpanel" aria-labelledby="custom-nav-home-tab">
                  <h4 class="mt-4"><strong>IDENTITAS YANG MEMBELI (PIHAK II): </strong></h4>
                  <hr>
                     <div class="row mt-2">
                     <div class="col-md-6">
               ...
               <h4 class="mt-4"><strong>DATA TANAH : </strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        <label for="nilai">Harga Tanah </label>
