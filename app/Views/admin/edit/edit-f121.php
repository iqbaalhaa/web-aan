         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Permohonan KTP (F121)</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-f121'); ?>" method="post">
                     <?= csrf_field() ?>
...
<?php foreach($surat as $data): ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <div class="col-md-6 mt-2">
                        ...
                        <input type="text" id="nkk" name="nkk" value="<?= $dt[1]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-6">
                        <label for="nama">Nama </label>
                        <input type="text" id="nama" name="nama" value="<?= $dt[2]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-3">
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        ...
                        <input type="text" id="rt" name="rt" value="<?= $dt[8]; ?>" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="rw">RW</label>
                        <input type="text" id="rw" name="rw" value="<?= $dt[9]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="jp">Jenis Permohonan</label>
                        <select id="jp" name="jp" class="form-control col-md-3" required>
                           <option value="<?= $dt[10]; ?>" selected><?= $dt[10]=='A'? 'Baru':''; ?><?= $dt[10]=='B'? 'Perpanjangan':''; ?><?= $dt[10]=='C'? 'Pergantian':''; ?></option>
                           <option value="A">Baru</option>
                           <option value="B">Perpanjangan</option>
                           <option value="C">Pergantian</option>
                        </select>
                     </div>
                  </div>
     ...
     $( "#nik" ).autocomplete({
       ...
       source: function( request, response ) {
        ...
        select: function (event, ui) {
           ...
           $('#nkk').val(ui.item.nkk); // display the selected text
