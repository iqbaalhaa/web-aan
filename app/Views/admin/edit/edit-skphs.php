   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Penghasilan</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-skphs'); ?>" method="post">
                     <?= csrf_field() ?>
         ...
         <?php foreach($surat as $data): ?>
                  ...
                  <h4 class="mt-4"><strong>KETERANGAN :</strong></h4>
                  <hr>
                  <div class="row">
                     <div class="col-md-12">
                     <label for="penghasilan">Jumlah Penghasilan</label>
                     <input type="text" id="penghasilan" name="penghasilan" value="<?= $dt['7']; ?>" class="form-control col-md-3" required>
                  </div>
               </div>
                <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="sumber">Sumber Penghasilan</label>
                     <input type="text" id="sumber" name="sumber" value="<?= $dt['8']; ?>" class="form-control col-md-12" required>
                  </div>
               </div>
