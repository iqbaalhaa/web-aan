         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Tugas</b></h4>
                  </div>
                  <div class="card-body mx-5 my-3">
                     <form action="<?= base_url('admin/surat/update-tugas'); ?>" method="post">
                        <?= csrf_field() ?>
                  ...
                  <?php $dt = explode('#', $data['isi_surat']); ?>
                     ...
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           ...
                           <input type="text" id="tugas" name="tugas" value="<?= $dt[0]; ?>" class="form-control col-md-12" required>
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12">
                           <label for="menimbang">Menimbang</label>
                           <textarea rows="4" id="menimbang" name="menimbang" class="form-control col-md-12" required><?= $dt[1]; ?></textarea>
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12">
                           <label for="mengingat">Mengingat</label>
                           <textarea rows="4" id="mengingat" name="mengingat" class="form-control col-md-12" required><?= $dt[2]; ?></textarea>
                        </div>
                     </div>
                     <br>
                     ...
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           ...
                           <input type="text" id="nosk" name="nosk" value="<?= $dt[3]; ?>" class="form-control col-md-6">
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           <label for="tentang">Tentang</label>
                           <input type="text" id="tentang" name="tentang" value="<?= $dt[4]; ?>" class="form-control col-md-12">
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           <label for="salinan">Salinan</label>
                           <input type="text" id="salinan" name="salinan" value="<?= $dt[5]; ?>" class="form-control col-md-6">
                        </div>
                     </div>
                     <?php endforeach; ?>
                     <br>
                     <div class="panel-body">
                        ...
                        <div class="control-group after-add-more">
                           <table width="100%" class="">
                             ...
                             <tr>
                              <td width="60%">
                              <input type="hidden" name="idst[]" value="<?= $r['id']; ?>">
                              <input type="hidden" name="kode_suratst[]" value="<?= $r['kode_tgs']; ?>">
                              <input type="text" name="namast[]" value="<?= $r['nama_tgs']; ?>" class="form-control">
                              </td>
                              <td width="25%"><input type="text" name="ketst[]" value="<?= $r['ket_tgs']; ?>" class="form-control"></td>
                     ...
                     <div class="copy invisible">
                       <div class="control-group">
                          <table width="100%" class="">
                            <tr>
                              <input type="hidden" name="kode_suratst[]" value="<?= $data['kode_surat']; ?>">
