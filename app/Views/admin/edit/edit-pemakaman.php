   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Pemakaman</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-pemakaman'); ?>" method="post">
                     <?= csrf_field() ?>
         ...
         <?php foreach($surat as $data): ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="tglm">Tanggal Pemakaman</label>
                        <input type="text" id="tglm" name="tglm" value="<?= $dt[7]; ?>" class="form-control col-md-4" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="makam">Lokasi/Tempat Pemakaman</label>
                        <input type="text" id="makam" name="makam" value="<?= $dt[8]; ?>" class="form-control col-md-12" required>
                     </div>
                  </div>
