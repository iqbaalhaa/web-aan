         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Rumah Tangga Miskin</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-skrtm'); ?>" method="post">
                  ...
                  <div class="row mt-2">
                     ...
                     <input type="text" id="untuk" name="untuk" value="<?= $dt['12']; ?>" class="form-control col-md-12" required><small>Contoh : Pengajuan BLT Dana Desa</small>
                  </div>
               </div>
