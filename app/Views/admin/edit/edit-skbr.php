         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Pengantar Barang</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-skbr'); ?>" method="post">
                     <?= csrf_field() ?>
...
<?php foreach($surat as $data): ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <input type="text" id="nama_barang" name="nama_barang" value="<?= $dt['5']; ?>" class="form-control col-md-6" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-6">
                     <label for="jenis_barang">Jenis Barang</label>
                     <input type="text" id="jenis_barang" name="jenis_barang" value="<?= $dt['6']; ?>" class="form-control col-md-12" required>
                  </div>
                     <div class="col-md-6">
                     <label for="jumlah">Jumlah/Ukuran Barang</label>
                     <input type="text" id="jumlah" name="jumlah" value="<?= $dt['7']; ?>" class="form-control col-md-6" required>
                  </div>
               </div>
                <div class="row mt-2">
                     <div class="col-md-12">
