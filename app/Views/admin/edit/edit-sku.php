         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Usaha</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-sku'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row">
                     ...
                     <input type="text" id="jenis_usaha" name="jenis_usaha" value="<?= $dt['5']; ?>" class="form-control col-md-6" required>
                  </div>
               </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="sejak">Berdiri sejak</label>
                     <input type="date" id="sejak" name="sejak" value="<?= $dt['6']; ?>" class="form-control col-md-3" required>
                  </div>
               </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="lokasi">Lokasi/Alamat Usaha</label>
                     <input type="text" id="lokasi" name="lokasi" value="<?= $dt['7']; ?>" class="form-control" required>
                  </div>
               </div>
