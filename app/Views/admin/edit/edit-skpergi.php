         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Keterangan Bepergian</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-skpergi'); ?>" method="post">
                     ...
                     <h4 class="mt-4"><strong>KETERANGAN TUJUAN :</strong></h4>
                     <hr>
                     <div class="row mt-2">
                        <div class="col-md-12">
                           <label for="tujuan">Tujuan</label>
                           <input type="text" id="tujuan" name="tujuan" value="<?= $dt['7']; ?>" class="form-control col-md-8" required>
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12">
                           <label for="kegiatan">Dalam rangka/Kegiatan</label>
                           <input type="text" id="kegiatan" name="kegiatan" value="<?= $dt['8']; ?>" class="form-control col-md-8" required>
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12">
                           <label for="tanggal">Tanggal Berangkat</label>
                           <input type="date" id="tanggal" name="tanggal" value="<?= $dt['9']; ?>" class="form-control col-md-3" required>
                        </div>
                     </div>
                     <div class="row mt-2">
                     <div class="col-md-12">
                           <label for="bawaan">Barang yang dibawa</label>
                           <input type="text" id="bawaan" name="bawaan" value="<?= $dt['10']; ?>" class="form-control col-md-8" required>
                        </div>
                     </div>
