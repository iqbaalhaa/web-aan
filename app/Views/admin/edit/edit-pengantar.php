         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Pengantar</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-pengantar'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <hr>
                     ...
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           ...
                           <input type="text" id="perihal" name="perihal" value="<?= $dt[0]; ?>" class="form-control col-md-12" required><small>Contoh : Laporan Penduduk Bulan Oktober 2023</small>
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                     ...
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           ...
                           <textarea rows="3" id="dasar" name="dasar" class="form-control col-md-12" required><?= $dt[2]; ?></textarea>
                     ...
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           ...
                           <input type="text" id="lembaga" name="lembaga" value="<?= $dt[3]; ?>" class="form-control col-md-6" required><small>Contoh : Camat Way Asalan</small>
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-12 mt-2">
                           <label for="alamat">Alamat yang dituju</label>
                           <input type="text" id="alamat" name="alamat" value="<?= $dt[4]; ?>" class="form-control col-md-12" required><small>Contoh : TEMPAT</small>
                        </div>
                     </div>
                     <br>
