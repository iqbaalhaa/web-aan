         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Edit Surat Pengantar SKCK</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/update-skck'); ?>" method="post">
                     <?= csrf_field() ?>
         ...
         <?php foreach($surat as $data): ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-6">
                        ...
                        <input type="text" id="kerjaan" name="kerjaan" value="<?= $dt['6']; ?>" class="form-control col-md-6" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
               ...
               <br>
                  <h4 class="mt-2"><strong>LEMBAGA YANG BERWENANG </strong></h4>
                  <hr>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="ke">Ditujukan ke</label>
                        <input type="text" id="ke" name="ke" value="<?= $dt['9']; ?>" class="form-control col-md-12" required>
                        <small>Contoh : Ka. POLRES Lampung Selatan</small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="di">Alamat/di</label>
                        <input type="text" id="di" name="di" value="<?= $dt['10']; ?>" class="form-control col-md-12" required>
