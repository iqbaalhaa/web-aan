         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Penghasilan</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-skphs'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <h4 class="mt-4"><strong>KETERANGAN PENGHASILAN :</strong></h4>
                  <hr>
                  <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="penghasilan">Jumlah Penghasilan</label>
                     <input type="text" id="penghasilan" name="penghasilan" class="form-control col-md-3" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="sumber">Sumber Penghasilan</label>
                     <input type="text" id="sumber" name="sumber" class="form-control col-md-12" required>
                  </div>
               </div>
