         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Kelahiran</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-kelahiran'); ?>" method="post">
                     <?= csrf_field() ?>
               ...
               <hr>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="anakke" name="anakke" class="form-control col-md-4" required>
                     </div>
                  </div>
               </div>
                  ...
                  <hr>
                   ...
                   <div class="row mt-2">
                     ...
                     <div class="col-md-3">
                        ...
                        <input type="text" id="tglli" name="tglli" class="form-control col-md-6" required>
                     </div>

                     <div class="col-md-3">
                        <label for="agamai">Agama Ibu</label>
                        <input type="text" id="agamai" name="agamai" class="form-control col-md-6" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
