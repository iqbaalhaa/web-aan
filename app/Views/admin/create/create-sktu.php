         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Tempat Usaha</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-sktu'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-6">
                        ...
                        <input type="text" id="jk" name="jk" class="form-control col-md-6" required>
                     </div>
                     <div class="col-md-6">
                        <label for="agama">Agama</label>
                        <input type="text" id="agama" name="agama" class="form-control col-md-6" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                  ...
                  <h4 class="mt-2"><strong>KETERANGAN TEMPAT USAHA:</strong></h4>
                  <hr>
                  <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="nama_usaha">Nama Usaha</label>
                     <input type="text" id="nama_usaha" name="nama_usaha" class="form-control col-md-6" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="jenis_usaha">Jenis/Bidang Usaha</label>
                     <input type="text" id="jenis_usaha" name="jenis_usaha" class="form-control col-md-6" required>
                  </div>
               </div>
                <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="sejak">Berdiri sejak</label>
                     <input type="date" id="sejak" name="sejak" class="form-control col-md-3" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="pekerja">Jumlah Pekerja</label>
                     <input type="number" id="pekerja" name="pekerja" class="form-control col-md-3" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="izin">Izin Usaha yang dimiliki</label>
                     <input type="text" id="izin" name="izin" class="form-control col-md-12" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="lokasi">Lokasi/Alamat Usaha</label>
