         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Domisili Lembaga/Organisasi</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-sklbg'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <input type="text" id="nama_lembaga" name="nama_lembaga" class="form-control col-md-12" required>
                  </div>
               </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="bidang_lembaga">Bidang</label>
                     <input type="text" id="bidang_lembaga" name="bidang_lembaga" class="form-control col-md-6" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
