         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Pengantar Pindah</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-pindah'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="tujuan" name="tujuan" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="keluarga">Jumlah Keluarga yang Ikut Pindah</label>
                        <input type="number" id="keluarga" name="keluarga" class="form-control col-md-3" required>
                     </div>
                  </div>
