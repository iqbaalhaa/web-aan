         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Cerai</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-cerai'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <h4><strong>DATA MANTAN SUAMI</strong></h4>
                  <hr>
                     <div class="row mt-2">
               ...
               <h4 class="mt-4"><strong>DATA MANTAN ISTRI : </strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="date" id="tglcerai" name="tglcerai" class="form-control col-md-3" required>
                     </div>
                  </div>
