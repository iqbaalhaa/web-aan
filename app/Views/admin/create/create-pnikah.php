         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Pernah Menikah</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-pnikah'); ?>" method="post">
                     <?= csrf_field() ?>
               ...
               <h4 class="mt-4"><strong>ISTRI : </strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="kerjaani" name="kerjaani" class="form-control col-md-6" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
