         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Orang Tua</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-skortu'); ?>" method="post">
                     <?= csrf_field() ?>
               ...
               <nav>
                <div class="row nav nav-tabs mt-4" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="custom-nav-home-tab" data-toggle="tab" href="#Ayah" role="tab" aria-controls="custom-nav-home" aria-selected="true"><b>AYAH</b></a>
                    <a class="nav-item nav-link" id="custom-nav-profile-tab" data-toggle="tab" href="#Ibu" role="tab" aria-controls="custom-nav-profile" aria-selected="false"><b>IBU</b></a>
                    <a class="nav-item nav-link" id="custom-nav-contact-tab" data-toggle="tab" href="#Anak" role="tab" aria-controls="custom-nav-contact" aria-selected="false"><b>ANAK</b></a>
                </div>
                </nav>
            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
            <div class="tab-pane fade show active" id="Ayah" role="tabpanel" aria-labelledby="custom-nav-home-tab">
            ...
            <div class="tab-pane fade show" id="Anak" role="tabpanel" aria-labelledby="custom-nav-home-tab">
