         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               ...
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-sewatanah'); ?>" method="post">
                     <?= csrf_field() ?>
               ...
               <h4 class="mt-4"><strong>DATA TANAH : </strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        ...
                        <input type="number" id="masa" name="masa" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="nilai">Nilai Sewa </label>
                        <input type="text" id="nilai" name="nilai" class="form-control col-md-12" required>
                     </div>
                  </div>
