         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Permohonan Izin Mendirikan Bangunan</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-simb'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="jenis_bangunan" name="jenis_bangunan" class="form-control col-md-12" required>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="fungsi_bangunan" name="fungsi_bangunan" class="form-control col-md-12" required>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-2">
                        ...
                        <input type="number" id="jumlah_lantai" name="jumlah_lantai" class="form-control col-md-12" required>                  
                     </div>
                     <div class="col-md-6">
                        <label for="ukuran_bangunan">Ukuran Bangunan</label>
                        <input type="text" id="ukuran_bangunan" name="ukuran_bangunan" class="form-control col-md-6" required>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="lokasi_bangunan" name="lokasi_bangunan" class="form-control col-md-12" required>
                     </div>
                  </div>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="ke" name="ke" class="form-control col-md-12" required>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="di" name="di" class="form-control col-md-12" required>
