         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Menikah</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-sknh'); ?>" method="post">
                     <?= csrf_field() ?>
               ...
               <h4 class="mt-4"><strong>ISTRI : </strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-6">
                        ...
                        <input type="text" id="secara" name="secara" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-6">
                        <label for="mahar">Mahar / Maskawin</label>
                        <input type="text" id="mahar" name="mahar" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-6">
                        <label for="saksi1">Nama Saksi 1</label>
                        <input type="text" id="saksi1" name="saksi1" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-6">
                        <label for="saksi2">Nama Saksi 2</label>
                        <input type="text" id="saksi2" name="saksi2" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="alasan">Alasan / Sebab Surat</label>
                        <input type="text" id="alasan" name="alasan" class="form-control col-md-12" required><small>Contoh : Buku Nikah masih dalam proses / Hilang, dll</small>
                     </div>
                  </div>
