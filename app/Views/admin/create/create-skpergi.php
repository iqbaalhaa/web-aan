         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Bepergian</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-skpergi'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <input type="text" id="tujuan" name="tujuan" class="form-control col-md-8" required>
                  </div>
               </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="kegiatan">Dalam rangka/Kegiatan</label>
                     <input type="text" id="kegiatan" name="kegiatan" class="form-control col-md-8" required>
                  </div>
               </div>
                <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="tanggal">Tanggal Berangkat</label>
                     <input type="date" id="tanggal" name="tanggal" class="form-control col-md-3" required>
                  </div>
               </div>
                <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="bawaan">Barang yang dibawa</label>
                     <input type="text" id="bawaan" name="bawaan" class="form-control col-md-8" required>
                  </div>
               </div>
