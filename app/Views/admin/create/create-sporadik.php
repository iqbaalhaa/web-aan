         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Pernyataan Penguasaan Fisik Bidang Tanah (Sporadik)</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-sporadik'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        ...
                        <input type="text" id="kerjaan" name="kerjaan" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-9">
               ...
               <h4 class="mt-4"><strong>DATA TANAH : </strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-2">
                        ...
                        <input type="text" id="rtrw" name="rtrw" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="desa">Desa/Kelurahan</label>
                        <input type="text" id="desa" name="desa" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-4">
                        <label for="kota">Kota Administrasi</label>
                        <input type="text" id="kota" name="kota" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="nib">NIB</label>
                        <input type="text" id="nib" name="nib" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-3">
                        <label for="statust">Status Tanah</label>
                        <input type="text" id="statust" name="statust" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                     ...
                     <div class="col-md-4">
                        ...
                        <input type="text" id="asal" name="asal" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-2">
                        <label for="sejak">Diperoleh Sejak</label>
                        <input type="text" id="sejak" name="sejak" class="form-control col-md-12" required>
                     </div>
                  </div>
               <h4 class="mt-4"><strong>BATAS - BATAS TANAH :</strong></h4>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        ...
                        <input type="text" id="namasaksi1" name="namasaksi1" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-2">
                        <label for="umursaksi1">Umur Saksi 1</label>
                        <input type="text" id="umursaksi1" name="umursaksi1" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="kerjaansaksi1">Pekerjaan Saksi 1</label>
                        <input type="text" id="kerjaansaksi1" name="kerjaansaksi1" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-4">
                        <label for="alamatsaksi1">Alamat Saksi 1</label>
                        <input type="text" id="alamatsaksi1" name="alamatsaksi1" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-3">
                        <label for="namasaksi2">Nama Saksi 2</label>
                        <input type="text" id="namasaksi2" name="namasaksi2" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-2">
                        <label for="umursaksi2">Umur Saksi 2</label>
                        <input type="text" id="umursaksi2" name="umursaksi2" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="kerjaansaksi2">Pekerjaan Saksi 2</label>
                        <input type="text" id="kerjaansaksi2" name="kerjaansaksi2" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-4">
                        <label for="alamatsaksi2">Alamat Saksi 2</label>
                        <input type="text" id="alamatsaksi2" name="alamatsaksi2" class="form-control col-md-12" required>
                     </div>
                  </div>
