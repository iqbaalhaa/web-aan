         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Lain-lain</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-sklain'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <h4 class="mt-4"><strong>ISI SURAT :</strong></h4>
                  <hr>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="nmsurat">Nama Surat</label>
                        <input type="text" id="nmsurat" name="nmsurat" class="form-control col-md-6" required><small>Misalnya : Surat Keterangan Kehilangan</small>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-12">
                     <label for="isi">Isi Surat</label>
                     <textarea rows="5" id="isi" name="isi" class="form-control col-md-12" required>
                     </textarea><small>Misalnya : Warga tersebut diatas adalah benar Warga Desa xxxxxxxxxx, yang bersangkutan adalah benar kehilangan Speda Motor Merk xxxx No. Plat BE 1010 AX.</small>
                  </div>
               </div>
