         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Usaha</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-sku'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <h4 class="mt-2"><strong>KETERANGAN :</strong></h4>
                  <hr>
                  <div class="row">
                     <div class="col-md-12">
