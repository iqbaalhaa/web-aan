         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Izin Gangguan</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-sig'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="nama_usaha" name="nama_usaha" class="form-control col-md-12" required>
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12">
                        ...
                        <input type="text" id="lokasi_usaha" name="lokasi_usaha" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
                        <label for="tetangga">Jumlah Tetangga yang memberikan Izin</label>
                        <input type="number" id="tetangga" name="tetangga" class="form-control col-md-2" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
