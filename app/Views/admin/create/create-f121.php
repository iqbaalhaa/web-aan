         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Permohonan KTP (F121)</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-f121'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <div class="col-md-6 mt-2">
                        ...
                        <input type="text" id="nkk" name="nkk" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-6">
                  ...
                  <div class="row mt-2">
                     <div class="col-md-3">
                        ...
                        <input type="text" id="rt" name="rt" class="form-control col-md-12" required>
                     </div>
                     <div class="col-md-3">
                        <label for="rw">RW</label>
                        <input type="text" id="rw" name="rw" class="form-control col-md-12" required>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12">
