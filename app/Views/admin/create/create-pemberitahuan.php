         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Pemberitahuan</b></h4>
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-pemberitahuan'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <hr>
                  <h4><strong>DETAIL PEMBERITAHUAN :</strong></h4>
                  <div class="row mt-2">
                     <div class="col-md-12 mt-2">
                        <label for="perihal">Perihal</label>
                        <input type="text" id="perihal" name="perihal" class="form-control col-md-12" required><small>Contoh : Jadwal Penyerahan BLT Dana Desa Bulan Oktober 2023</small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12 mt-2">
                        <label for="lampiran">Lampiran</label>
                        <input type="text" id="lampiran" name="lampiran" class="form-control col-md-6" required><small>Contoh : 1 (satu) lembar</small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12 mt-2">
                        <label for="ke">Ditujukan kepada </label>
                        <input type="text" id="ke" name="ke" class="form-control col-md-6" required><small>Contoh : Ketua RT se-Desa Dagelan</small>
                     </div>
                  </div>
                  <div class="row mt-2">
                     <div class="col-md-12 mt-2">
                  ...
                  <div class="row mt-2">
                     <div class="col-md-12 mt-2">
                        ...
                        <textarea rows="4" id="isi" name="isi" class="form-control col-md-12" required></textarea>
                        <small>Contoh : Meneruskan Surat Camat Way Asalan Nomor : 123, Tanggal 28 Oktober 2023, Perihal Penyerahan BLT Dana Desa Bulan Oktober 2023, Perlu kami sampaikan bahwa Penyerah BLT Dana Desa bulan Oktober tahun 2023 ditunda hingga waktu yang belum ditentukan</small>
                     </div>
                  </div>
                  <br>
