         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Kelurga Tidak Mampu (Keluarga)</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-skktm'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <input type="text" id="untuk" name="untuk" class="form-control col-md-12" required><small>Contoh : Pengajuan BPJS</small>
                  </div>
               </div>
