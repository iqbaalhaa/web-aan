         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Pengantar Ternak</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->
               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-skt'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <input type="text" id="nama_ternak" name="nama_ternak" class="form-control col-md-6" required><small>Contoh : Sapi atau Kambing</small>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-6">
                     <label for="jenis_ternak">Jenis Ternak</label>
                     <input type="text" id="jenis_ternak" name="jenis_ternak" class="form-control col-md-12" required>
                  </div>
                     <div class="col-md-6">
                     <label for="ciri_ternak">Ciri - ciri Ternak</label>
                     <input type="text" id="ciri_ternak" name="ciri_ternak" class="form-control col-md-12" required><small>Contoh : Warna Putih, Panjang Tanduk 15cm</small>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="asal">Asal Ternak</label>
                     <input type="text" id="asal" name="asal" class="form-control col-md-9" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="tujuan">Tujuan Ternak</label>
                     <input type="text" id="tujuan" name="tujuan" class="form-control col-md-9" required>
                  </div>
               </div>
               <div class="row mt-2">
                     <div class="col-md-12">
                     <label for="plat">No. Plat Kendaraan</label>
                     <input type="text" id="plat" name="plat" class="form-control col-md-4" required>
                  </div>
               </div>
