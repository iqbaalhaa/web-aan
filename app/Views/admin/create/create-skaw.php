         ...
         <div class="col-lg-12 col-md-12">
            <div class="card">
               <div class="card-header card-header-info">
                  <h4 class="card-title"><b>Form Input Surat Keterangan Ahli Waris</b></h4>
                  <!-- <p class="card-category">Angkatan 2022/2023</p> -->               </div>
               <div class="card-body mx-5 my-3">
                  <form action="<?= base_url('admin/surat/create-skaw'); ?>" method="post">
                     <?= csrf_field() ?>
                  ...
                  <div class="row mt-2">
                     ...
                     <div class="col-md-3">
                        ...
                        <input type="text" id="tgll" name="tgll" class="form-control col-md-6" required>
                     </div>
                     <div class="col-md-2">
                  ...
                  <div class="row mt-2">
                        <div class="col-md-3">
                           ...
                           <input type="text" id="tglm" name="tglm" class="form-control col-md-12" required>
                        </div>
                        <div class="col-md-6">
                           <label for="tmpm">Tempat Meninggal</label>
                           <input type="text" id="tmpm" name="tmpm" class="form-control col-md-12" required>
                        </div>
                     </div>
                  <div class="row mt-2">
                        <div class="col-md-6">
                           <label for="keluarga">Nama Suami/Istri</label>
                           <input type="text" id="keluarga" name="keluarga" class="form-control col-md-12" required>
                        </div>
                     </div>
                     <div class="row mt-2">
                        <div class="col-md-2">
                           <label for="jaw">Jumlah Anak</label>
                           <input type="text" id="jaw" name="jaw" class="form-control col-md-12" required>
                        </div>
                     </div>
                  <div class="panel-body">
                     ...
                     <div class="control-group after-add-more">
                        <table class="">
                          ...
                          <tr>
                           <input type="hidden" id="kode_surat" name="kode_surataw[]" value="<?php echo $kodesurat; ?>">
